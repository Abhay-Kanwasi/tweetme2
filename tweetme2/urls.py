...
from tweets.views import home_view, tweet_detail_view, tweet_create_view
...
urlpatterns = [
    ...
    path('react/', TemplateView.as_view(template_name='react.html')), # This will connect react to out django applicaiton
    re_path('create-tweet',tweet_create_view),
